...
HS.scenes.meal={
 ...
 pathways:{
  between:{name:'Between meals',node:'betweenP',chip:'over hours',region:'meal',segDur:1000,
   ...
   hots:[
    {org:'panc',num:1,dx:34,dy:20,seg:null,t:2,region:'panc',one:'Pancreas releases glucagon',adv:'Alpha cells release glucagon as glucose falls',lab:{body:'Pancreas',organ:'glucagon',structure:'Alpha cells release glucagon'},ldx:64,ldy:12},
  ...
  after:{name:'After a meal',node:'afterP',chip:'within minutes, over hours',region:'fed',segDur:900,
   ...
   hots:[
    {org:'int',num:1,dx:-46,dy:18,seg:null,t:1,region:'int',one:'Glucose from food enters the blood',adv:'SGLT1 and GLUT2 carry glucose across the intestinal lining',lab:{body:'Intestines',organ:'glucose',structure:'Lining absorbs glucose'},ldx:-86,ldy:12},
    {org:'panc',num:2,dx:34,dy:20,seg:'absorb',t:2,region:'panc',one:'Pancreas releases insulin',adv:'Beta cells release insulin and C-peptide as glucose rises',lab:{body:'Pancreas',organ:'insulin',structure:'Beta cells release insulin'},ldx:64,ldy:12},
