...
HS.scenes.stress={
 ...
 pathways:{
  fast:{name:'Fast route',node:'fastP',chip:'within seconds',region:'fast',layer:'nervous',segDur:800,
   ...
   afterPlay:{tip:{key:'slow',text:'That was the fast route, within seconds. Now follow the slow route: choose Slow — or press ▶ Watch it all to see both across the ribbon.',pos:{right:16,bottom:214}}},
