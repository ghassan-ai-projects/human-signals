 ...
 pathways:{
  fast:{name:'Fast route',node:'fastP',chip:'within seconds',region:'fast',layer:'nervous',segDur:800,
   ...
   hots:[
    ...
    {org:'liver',num:4,dx:-10,dy:-34,seg:null,t:1,region:'liver',one:'Liver releases glucose',lab:{body:'Liver',organ:'glucose',structure:'Liver cells release glucose'},ldx:-70,ldy:-4}],
  ...
  slow:{name:'HPA axis',node:'hpaP',chip:'over minutes, lasting hours',region:'hpa',segDur:1000,minTime:1,orgRegions:{brain:'brain'},
   ...
   gate:{
    routes:['f1','f2'],at:['f1',.5],labelRoutes:['f1'],tipKey:'ghost',
