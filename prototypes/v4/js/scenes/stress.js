...
HS.scenes.stress={
 ...
 pathways:{
  fast:{name:'Fast route',node:'fastP',chip:'within seconds',region:'fast',layer:'nervous',segDur:800,
   ...
   afterPlay:{tip:{key:'slow',text:'That was the fast route, within seconds. Now follow the slow route: choose Slow — or press ▶▶ on the pathway bar to see both across the ribbon.',pos:{right:16,bottom:214}}},
   reflect:{q:'In a sentence, how does the fast route get the body ready so quickly?',model:'Nerve signals reach the adrenal medulla within seconds; it releases adrenaline into the blood, and the heart, lungs and liver respond, so the body is ready almost at once. The slow route is different: it takes over minutes and lasts hours, and cortisol\u2019s brake on the brain is what turns that slow response down.'}
  },
